...
//        Remember, .this specifies the variable IN THIS CLASS (Sub_Class), and not some parameter (String name)
...
//Q: If you call super here, which constructor will be chosen?
//A: It will only look at the constructor of the SUPER class (Sub_Class extends Super_Class).
//   However, if the superclass is also a subclass and has super in it, then it will also go to it's superclass as well
...
main()
{
    //This will use the constructor with no params, which will call super();, which will call the Super_Class
    Sub_Sub_Class obj1 = new Sub_Sub_Class();

    Sub_Sub_Class obj2 = new Sub_Sub_Class(1,2,"test");
}
...
class using_C_and_D
{
    public static void main (String[] args)
    {
        ...
        //IMPORTANT: c = d shows that a SUPERCLASS object can be assigned to its subclass objects
        c = d;
        c.c=1;
...
class TwoDShape
{
    ...
    TwoDShape(TwoDShape ob)     //LOOK HERE WHEN READING THE COMMENT IN SHAPES. SEE? ITS LOOKING FOR A TWODSHAPE, BUT IS SENT A TRIANGLE
                                //THis works because Triangle is a subclass of TwoDShape
    {
        width = ob.width;
        hieght = ob.hieght;
    }
