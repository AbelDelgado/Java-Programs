...
class access_Modifiers
{
    ...
    //If the method will be accessed OUTSIDE of this class (when the main from another class calls it, should be PUBLIC
    public void enter_Index_And_Value(int index,int value_Entered_Into_Index)
    {        
    ...
    //If only this class is going to access it, then make it a PRIVATE method
    ...
    public void print_Value(int index)
    {
        if(!check_If_Valid(index))
        {
            return;
...
class access_Modifiers_Methods
{
    ...
    public static void main(String[] args)            
    {
        ...
        runProg1.x = 0;
        runProg1.enter_Index_And_Value(0, 5);
        runProg1.print_Value(0);
...
class call_By_Value_Or_Reference_Methods
{        
    //==================== Call by Value =========================
    //The main focus is the i variable found in main and in call_By_Value
    //i is set to 0 in main, and is thebn sent to call_By_Value (in another class)
    //call_By_Value takes i's VALUE and then modifies it
    //However, when we print out i's value back in main, it still remains 0
    //We only passed it's VALUE
    ...
    //==================== Call by Reference =========================
    //Sending Obj2 to the "call_By_Reference" method change its values 
    //Once we return to main, obj2 will now have new permanently changed values
    //These values have changed because call_By_Reference changed their REFERENCE
    int x,y;                                            
    
    public call_By_Value_Or_Reference_Methods(int x,int y)
    {
        this.x = x;                                     //This initializes the variables when the object is made
        this.y = y;
    }
    
    void call_By_Reference(call_By_Value_Or_Reference_Methods obj)
    {
        obj.x = obj.x + obj.y;
        obj.y = -obj.y;
    }
    
     void show_Values(call_By_Value_Or_Reference_Methods z)
    {
         
        
        System.out.println("Look at object that called the method: "+x);  //prints out the values for obj1's x
        System.out.println("Look at object that called the method: "+y);  //prints out the values for obj1's y                     
        System.out.println("Object that was passed: "+z.x);  //prints out the values for obj2's x
        System.out.println("Object that was passed: "+z.y);  //prints out the values for obj2's y
...
class call_By_Example
{
    public static void main (String[] args)
    {
        ...
        var obj1 = new call_By_Value_Or_Reference_Methods(1,2); 
        obj1.call_By_Value(i);                                 //call by value because i will NOT be modified
        ...
        //Call by Reference 
        var obj2 = new call_By_Value_Or_Reference_Methods(3,4);
        System.out.println("The original value of x is: "+obj2.x);
        System.out.println("The original value of y is: "+obj2.y);
        
        obj2.call_By_Reference(obj2); //call by reference because the obj2 WILL BE MODIFIED
        System.out.println("The value of x is now: "+obj2.x);
        System.out.println("The value of y is now: "+obj2.y);
...
//Understand part 2, and this will make sense
...
//--------------------Part 5 - Automatic Type Conversions------------------------------------------------------    
...
//                 - ALL objects made from the same class will SHARE THE SAME VALUE for that variable
...
//If you know how many arguments are needed beforehand, you can create a method with a set number of parameters or overload methods
//If you don't know how many arguments you will have, the next best thing was to use an array and store all the arguments in there, and send that array to a method
...
public class Section_F 
{
    ...
    public static void main(String[] args) 
    {
        ...
        var runProgram1 = new call_By_Example();
